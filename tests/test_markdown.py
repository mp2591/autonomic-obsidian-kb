...
class MarkdownTests(unittest.TestCase):
    ...
    def test_progressive_layers_links_and_tags(self):
        ...
        self.assertEqual(p.layers[0], "Pointer")
        self.assertEqual(p.layers[2], "Summary with [[Other Note]] and #beta")
        self.assertEqual(p.links, ["Other Note"])
    ...
    def test_unlayered_markdown_gets_low_cost_fallbacks(self):
        ...
        self.assertIn("First paragraph", p.layers[1])
        self.assertIn("Second paragraph", p.layers[2])
