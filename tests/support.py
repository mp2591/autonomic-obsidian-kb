...
def write_memory(
    ...
    **metadata: Any,
    ...
    base = {
        ...
        "validated": now,
        "freshness": "verified",
        "token_cost": max(40, len(summary) // 2),
        "utility": 0.8,
    ...
    layers = {
        0: summary[:100],
        1: summary,
        2: summary + " Additional summary context for the common path.",
        3: summary + " Full detail, rationale, edge cases, and implementation context. " * 4,
    }
    path = config.vault / relative
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text(render_note(base, layers), encoding="utf-8")
    return path
